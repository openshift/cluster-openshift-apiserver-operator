...
%global package_name origin-cluster-openshift-apiserver-operator
%global product_name OpenShift Cluster openshift-apiserver Operator
%global import_path github.com/openshift/cluster-openshift-apiserver-operator
...
for bin in cluster-openshift-apiserver-operator
do
  echo "+++ INSTALLING ${bin}"
...
%doc README.md
%license LICENSE
%{_bindir}/cluster-openshift-apiserver-operator
