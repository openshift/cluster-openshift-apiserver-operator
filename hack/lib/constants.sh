...
readonly OS_GO_PACKAGE=github.com/openshift/cluster-openshift-apiserver-operator
...
readonly OS_CROSS_COMPILE_TARGETS=(
  cmd/cluster-openshift-apiserver-operator
)
...
function os::build::images() {
  ...
  os::build::image "${tag_prefix}-cluster-openshift-apiserver-operator" .
}
